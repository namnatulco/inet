...
#ifndef __INET_NETWORKLAYEROSGVISUALIZER_H
#define __INET_NETWORKLAYEROSGVISUALIZER_H
 ...
 */
class INET_API NetworkLayerOsgVisualizer : public NetworkLayerVisualizerBase
{
#ifdef WITH_OSG
...
#endif // ifndef __INET_NETWORKLAYEROSGVISUALIZER_H
