...
#ifndef __INET_LINKLAYERCANVASVISUALIZER_H
#define __INET_LINKLAYERCANVASVISUALIZER_H
 ...
 */
class INET_API LinkLayerCanvasVisualizer : public LinkLayerVisualizerBase
{
  protected:
...
#endif // ifndef __INET_LINKLAYERCANVASVISUALIZER_H
